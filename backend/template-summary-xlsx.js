...
function buildSummaryTemplate() {
  ...
  const aoa = [
    ['（示例）第十四批经济评审', '', '', '', '', '', '', '', '', ''],
    ['序号', '项目编号', '项目名称', '项目承建部门', '项目类型', '合同额（元）', '内部信息系统填报预估成本（元）', '是否属于限制分包', '专业分包范围'],
    [1, 'XM20260001', '示例项目名称一', '某事业部（赋能中心）', '施工类项目', 15200000, 13665901.36, '否', '含开发与实施'],
    [2, 'XM20260002', '示例项目名称二', '某事业部（赋能中心）', '数字化类项目', 1427000, 1212604.43, '否', '']
  ];
